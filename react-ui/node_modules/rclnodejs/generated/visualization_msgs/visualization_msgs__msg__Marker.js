...
class MarkerWrapper {
  constructor(other, willCheckConsistency = false) {
    ...
    if (typeof other === 'object' && other._refObject) {
      ...
      this._texture_resourceIntialized = true;
  ...
  _initMembers() {
    ...
    this._wrapperFields.points = PointWrapper.createArray();
    this._wrapperFields.colors = ColorRGBAWrapper.createArray();
    this._texture_resourceIntialized = false;
  ...
  freeze(own = false, checkConsistency = false) {
      if (checkConsistency && !this._nsIntialized) {
      ...
      if (checkConsistency && !this._frame_lockedIntialized) {
        throw new TypeError('Invalid argument: frame_locked in Marker');
      }
      if (checkConsistency && !this._texture_resourceIntialized) {
        throw new TypeError('Invalid argument: texture_resource in Marker');
      }
      if (checkConsistency && !this._textIntialized) {
        throw new TypeError('Invalid argument: text in Marker');
      }
      if (checkConsistency && !this._mesh_resourceIntialized) {
        throw new TypeError('Invalid argument: mesh_resource in Marker');
      }
      if (checkConsistency && !this._mesh_use_embedded_materialsIntialized) {
    ...
    if (own) {
      this._wrapperFields.texture_resource.freeze(own, checkConsistency);
    }
    this._refObject.texture_resource = this._wrapperFields.texture_resource.refObject;
    this._wrapperFields.texture.freeze(own, checkConsistency);
    this._refObject.texture = this._wrapperFields.texture.refObject;
    this._wrapperFields.uv_coordinates.freeze(own, checkConsistency);
    ...
    this._wrapperFields.mesh_file.freeze(own, checkConsistency);
  ...
  get texture_resource() {
    if (!this._texture_resourceIntialized) {
      return undefined;
    }
