# TODO FIXME implement the launch file for the arm_moveit2.launch.py
...
def generate_launch_description():
    moveit_config = (
        MoveItConfigsBuilder("your_custom_arm_package")
        .robot_description(
            file_path="config/your_custom_arm.urdf.xacro"
        )  # Update this line
