...
if __name__ == "__main__":
    ...
    # drive_interface.ping_motor(NodeID.RF_DRIVE)
    # drive_interface.run_motor_speed(NodeID.RF_DRIVE, 1000)
    ...
    # arm_interface.run_motor_speed(NodeID.WAIST, 600)

    arm_interface.run_motor_position(NodeID.SHOULDER, 5)
    # # arm_interface.read_position(NodeID.WAIST)
    
    # arm_interface.read_all_faults(NodeID.SHOULDER)
    # arm_interface.calibrate_motor(NodeID.SHOULDER)
    # arm_interface.read_state(NodeID.SHOULDER)
    ...
    # arm_interface.read_all_faults(NodeID.SHOULDER)
    # arm_interface.read_all_faults(NodeID.SHOULDER)
    # arm_interface.ping_motor(NodeID.WAIST)
    # arm_interface.read_all_faults(NodeID.WAIST)
    # arm_interface.read_all_faults(NodeID.SHOULDER)

    # for i in range(10):
    #     time.sleep(2.5)
    #     arm_interface.run_motor_position(NodeID.ELBOW, 30 + i*30 )   

    # for i in range(10):
    #     time.sleep(2.5)
    #     arm_interface.run_motor_position(NodeID.ELBOW, 330 - i*30 )   

    # arm_interface.read_all_faults(NodeID.SHOULDER)
    # arm_interface.read_state(NodeID.WAIST)
