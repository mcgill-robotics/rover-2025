...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo ""
            echo "Default Camera Configuration:"
            echo "  jetson-01-cam00 -> Port 5000 (Front Camera)"
            echo "  jetson-01-cam01 -> Port 5001 (Left Camera)"
            echo "  jetson-01-cam02 -> Port 5002 (Right Camera)"
            echo ""
            echo "Example:"
...
echo ""
echo "Default Cameras (RTP/H.264 streams):"
echo "  jetson-01-cam00 -> UDP Port 5000"
echo "  jetson-01-cam01 -> UDP Port 5001"
echo "  jetson-01-cam02 -> UDP Port 5002"
echo ""
echo "API Endpoints:"
