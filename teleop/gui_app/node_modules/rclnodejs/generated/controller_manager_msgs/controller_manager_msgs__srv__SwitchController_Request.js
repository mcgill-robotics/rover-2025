...
class SwitchController_RequestWrapper {
  constructor(other, willCheckConsistency = false) {
    ...
    if (typeof other === 'object' && other._refObject) {
      ...
      this._activate_asapIntialized = true;
  ...
  _initMembers() {
    ...
    this._activate_asapIntialized = false;
  ...
  freeze(own = false, checkConsistency = false) {
      if (checkConsistency && !this._strictnessIntialized) {
        throw new TypeError('Invalid argument: strictness in SwitchController_Request');
      }
      if (checkConsistency && !this._start_asapIntialized) {
        throw new TypeError('Invalid argument: start_asap in SwitchController_Request');
      }
      if (checkConsistency && !this._activate_asapIntialized) {
        throw new TypeError('Invalid argument: activate_asap in SwitchController_Request');
      }
    if (!own) {
      this._wrapperFields.activate_controllers.fill(this._activate_controllersArray);
      this._wrapperFields.activate_controllers.freeze(own, checkConsistency);
    ...
    if (!own) {
      ...
      this._wrapperFields.deactivate_controllers.freeze(own, checkConsistency);
  ...
  get activate_asap() {
    if (!this._activate_asapIntialized) {
      return undefined;
    }
