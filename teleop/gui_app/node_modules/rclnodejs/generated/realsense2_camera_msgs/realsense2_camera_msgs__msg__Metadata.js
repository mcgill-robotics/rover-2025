...
const MetadataRefStruct = StructType({
  ...
  json_data: primitiveTypes.string,
});
...
class MetadataWrapper {
  constructor(other, willCheckConsistency = false) {
    ...
    if (typeof other === 'object' && other._refObject) {
      ...
      this._json_dataIntialized = true;
      this._wrapperFields.json_data =  new StringWrapper(other._wrapperFields.json_data);
  ...
  _initMembers() {
    ...
    this._json_dataIntialized = false;
    this._wrapperFields.json_data = new StringWrapper();
  }
  ...
  freeze(own = false, checkConsistency = false) {
      if (checkConsistency && !this._json_dataIntialized) {
        throw new TypeError('Invalid argument: json_data in Metadata');
      }
    this._wrapperFields.header.freeze(own, checkConsistency);
    this._refObject.header = this._wrapperFields.header.refObject;
    if (own) {
      this._wrapperFields.json_data.freeze(own, checkConsistency);
    }
    this._refObject.json_data = this._wrapperFields.json_data.refObject;
  }
  serialize() {
  ...
  deserialize(refObject) {
    ...
    this._json_dataIntialized = true;
    this._wrapperFields.json_data.data = refObject.json_data.data;
  }
  ...
  static freeStruct(refObject) {
    ...
    StringWrapper.freeStruct(refObject.json_data);
  }
  static destoryRawROS(msg) {
    MetadataWrapper.freeStruct(msg.refObject);
  }
  static type() {
    return {pkgName: 'realsense2_camera_msgs', subFolder: 'msg', interfaceName: 'Metadata'};
  }
  static isPrimitive() {
    return false;
  }
  ...
  get json_data() {
    if (!this._json_dataIntialized) {
      return undefined;
    }
    return this._wrapperFields.json_data.data;
  }
  set json_data(value) {
    this._json_dataIntialized = true;
    this._wrapperFields.json_data.data = value;
  }
  copyRefObject(refObject) {
    ...
    this._json_dataIntialized = true;
    this._wrapperFields.json_data.copyRefObject(this._refObject.json_data);
  }
  copy(other) {
    this._refObject = new MetadataRefStruct(other._refObject.toObject());
    this._wrapperFields.header.copy(other._wrapperFields.header);
    this._json_dataIntialized = true;
    this._wrapperFields.json_data.copy(other._wrapperFields.json_data);
  }
  static get classType() {
    return MetadataWrapper;
  }
  static get ROSMessageDef() {
    return {"constants":[],"fields":[{"name":"header","type":{"isArray":false,"arraySize":null,"isUpperBound":false,"isDynamicArray":false,"isFixedSizeArray":false,"pkgName":"std_msgs","type":"Header","stringUpperBound":null,"isPrimitiveType":false},"default_value":null},{"name":"json_data","type":{"isArray":false,"arraySize":null,"isUpperBound":false,"isDynamicArray":false,"isFixedSizeArray":false,"pkgName":null,"type":"string","stringUpperBound":null,"isPrimitiveType":true},"default_value":null}],"baseType":{"pkgName":"realsense2_camera_msgs","type":"Metadata","stringUpperBound":null,"isPrimitiveType":false},"msgName":"Metadata"};
  }
  hasMember(name) {
    let memberNames = ["header","json_data"];
