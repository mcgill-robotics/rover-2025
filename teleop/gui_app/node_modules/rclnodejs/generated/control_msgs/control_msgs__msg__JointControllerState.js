...
class JointControllerStateWrapper {
  ...
  freeze(own = false, checkConsistency = false) {
      if (checkConsistency && !this._set_pointIntialized) {
        throw new TypeError('Invalid argument: set_point in JointControllerState');
      }
      if (checkConsistency && !this._process_valueIntialized) {
        throw new TypeError('Invalid argument: process_value in JointControllerState');
      }
      if (checkConsistency && !this._process_value_dotIntialized) {
      ...
      if (checkConsistency && !this._time_stepIntialized) {
