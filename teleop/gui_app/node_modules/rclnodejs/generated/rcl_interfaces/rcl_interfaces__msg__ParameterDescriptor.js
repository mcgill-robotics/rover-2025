...
const ParameterDescriptorRefStruct = StructType({
  ...
  dynamic_typing: primitiveTypes.bool,
...
class ParameterDescriptorWrapper {
  constructor(other, willCheckConsistency = false) {
    ...
    if (typeof other === 'object' && other._refObject) {
      ...
      this._dynamic_typingIntialized = true;
  ...
  _initMembers() {
    ...
    this._read_onlyIntialized = true;
    this._refObject.dynamic_typing = false;
    this._dynamic_typingIntialized = true;
    this._wrapperFields.floating_point_range = FloatingPointRangeWrapper.createArray();
    this._wrapperFields.integer_range = IntegerRangeWrapper.createArray();
  }
  ...
  freeze(own = false, checkConsistency = false) {
      ...
      if (checkConsistency && !this._descriptionIntialized) {
        throw new TypeError('Invalid argument: description in ParameterDescriptor');
      }
      if (checkConsistency && !this._additional_constraintsIntialized) {
        throw new TypeError('Invalid argument: additional_constraints in ParameterDescriptor');
      }
      if (checkConsistency && !this._read_onlyIntialized) {
        throw new TypeError('Invalid argument: read_only in ParameterDescriptor');
      }
      if (checkConsistency && !this._dynamic_typingIntialized) {
        throw new TypeError('Invalid argument: dynamic_typing in ParameterDescriptor');
      }
    if (own) {
  ...
  deserialize(refObject) {
    ...
    this._dynamic_typingIntialized = true;
    this._refObject.dynamic_typing = refObject.dynamic_typing;
  ...
  get dynamic_typing() {
    if (!this._dynamic_typingIntialized) {
      return undefined;
    }
    return this._refObject.dynamic_typing;
  }
  set dynamic_typing(value) {
    this._dynamic_typingIntialized = true;
    this._refObject.dynamic_typing = value;
  }
